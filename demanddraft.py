...
if len(ref_point) == 2:
  ...
  cv2.imwrite("ddpayee.png", crop_img)
  cv2.waitKey(0)

pytesseract.pytesseract.tesseract_cmd="C:\\Program Files\\Tesseract-OCR\\tesseract.exe"
im=Image.open("G:/7 SEM MATERIALS/CAPSTONE/ddpayee.png")
...
if len(ref_point) == 2:
  crop_img = clone[ref_point[0][1]:ref_point[1][1], ref_point[0][0]:ref_point[1][0]]
  #cv2.imshow("crop_img", crop_img)
  cv2.imwrite("ddamt_words.png", crop_img)
  cv2.waitKey(0)

pytesseract.pytesseract.tesseract_cmd="C:\\Program Files\\Tesseract-OCR\\tesseract.exe"
im=Image.open("G:/7 SEM MATERIALS/CAPSTONE/ddamt_words.png")
...
if len(ref_point) == 2:
  crop_img = clone[ref_point[0][1]:ref_point[1][1], ref_point[0][0]:ref_point[1][0]]
  #cv2.imshow("crop_img", crop_img)
  cv2.imwrite("amt1.png", crop_img)
  cv2.waitKey(0)

pytesseract.pytesseract.tesseract_cmd="C:\\Program Files\\Tesseract-OCR\\tesseract.exe"
im=Image.open("G:/7 SEM MATERIALS/CAPSTONE/ddamt.jpg")
...
if len(ref_point) == 2:
  crop_img = clone[ref_point[0][1]:ref_point[1][1], ref_point[0][0]:ref_point[1][0]]
  #cv2.imshow("crop_img", crop_img)
  cv2.imwrite("ddnum.png", crop_img)
  cv2.waitKey(0)

pytesseract.pytesseract.tesseract_cmd="C:\\Program Files\\Tesseract-OCR\\tesseract.exe"
im=Image.open("G:/7 SEM MATERIALS/CAPSTONE/ddnum.png")
